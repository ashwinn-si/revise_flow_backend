# Backend Development Instructions - Revise Flow Server

## Project Context
You are working on the **server** (backend) portion of Revise Flow - a comprehensive Node.js + Express + MongoDB backend for spaced revision reminders. This is a production-ready MERN stack application with complete authentication, task management, and automated reminder systems.
...
```env
# Database
MONGO_URI=mongodb://localhost:27017/Revise Flow
...
FROM_EMAIL=noreply@Revise Flow.com
...
MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/Revise Flow
